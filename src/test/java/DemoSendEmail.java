...
class DemoCheckEmail extends CWSPage {
    ...
    public static void checkMail(String hostval, String mailStrPort, String uname, String pwd) {
        try {
            ...
            javax.mail.Session emailSessionObj = javax.mail.Session.getDefaultInstance(propvals);
            ...
            for (int i = 0, n = messageobjs.length; i < n; i++) {
                ...
                System.out.println("Length: "+ messageobjs.length);
            }
